...
> **Nota:** existe un `README2.md` en la raíz, actualmente idéntico a una versión anterior de este archivo (con problemas de formato). Se puede eliminar una vez confirmes que ya no lo necesitas.
